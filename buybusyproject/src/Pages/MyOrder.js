...
import { productSelector, productCancelOrderThunk } from "../Redux/Reducers/productReducer";
                ...
                <div className={styles.mainContainer}>
                    ...
                    {myorders.length === 0 ?
                        ...
                        <div className={styles.orderListContainer}>
                            {myorders.map((order, i) => <OrderDetail key={i} order={order} cancleOrder={() => dispatch(productCancelOrderThunk(i))} />)}
                        </div>
                    }
                </div>
            }
            <footer>Order can be cancel within 2 to 3 day otherwise it will not cancel!</footer>
        </>
    );
}